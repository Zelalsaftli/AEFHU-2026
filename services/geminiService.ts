...
export const predictMetabolicHealth = async (
  ...
  const prompt = `
    ...
    6. تقديم نصائح فنية وعلاجية وقائية دقيقة (مثل: إضافة الأحماض الأمينية المحمية، الخميرة لتحسين الهضم، الأملاح الأنيونية لتجنب حمى الحليب، الفيتامينات والمعادن، أو تعديل نسبة العلف المالئ) حسب الحالة الحرجة للبقرة.
